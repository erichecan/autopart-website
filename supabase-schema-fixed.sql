...
INSERT INTO category_translations (category_id, language, name) VALUES
    ...
    ((SELECT id FROM categories WHERE slug = 'engine'), 'fr', 'Systeme Moteur'),
    ...
    ((SELECT id FROM categories WHERE slug = 'brake'), 'fr', 'Systeme de Freinage'),
    ...
    ((SELECT id FROM categories WHERE slug = 'suspension'), 'fr', 'Systeme de Suspension'),
    ((SELECT id FROM categories WHERE slug = 'suspension'), 'es', 'Sistema de Suspension'),
    ...
    ((SELECT id FROM categories WHERE slug = 'electrical'), 'fr', 'Systeme Electrique'),
    ((SELECT id FROM categories WHERE slug = 'electrical'), 'es', 'Sistema Electrico'),
    ...
    ((SELECT id FROM categories WHERE slug = 'filter'), 'fr', 'Systeme de Filtration'),
    ...
    ((SELECT id FROM categories WHERE slug = 'lighting'), 'fr', 'Systeme Eclairage'),
    ((SELECT id FROM categories WHERE slug = 'lighting'), 'es', 'Sistema de Iluminacion'),
...
INSERT INTO product_translations (product_id, language, name, description) VALUES
    ...
    ((SELECT id FROM products WHERE slug = 'brake-pads-premium'), 'fr', 'Plaquettes de Frein Premium', 'Fabriquees avec des materiaux de haute qualite pour des performances de freinage superieures'),
    ...
    ((SELECT id FROM products WHERE slug = 'spark-plugs-platinum'), 'fr', 'Bougies Platine', 'Bougies allumage platine haute performance pour un allumage fiable'),
    ((SELECT id FROM products WHERE slug = 'spark-plugs-platinum'), 'es', 'Bujias de Platino', 'Bujias de platino de alto rendimiento para encendido confiable'),
    ...
    ((SELECT id FROM products WHERE slug = 'oil-filter-premium'), 'fr', 'Filtre Huile Premium', 'Materiau de filtration de qualite pour une protection efficace du moteur'),
    ((SELECT id FROM products WHERE slug = 'oil-filter-premium'), 'es', 'Filtro de Aceite Premium', 'Material de filtracion de calidad para proteccion efectiva del motor'),
